...
//   { name: "Forum", href: "https://forum.rnirealestate.com/" },
...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* NAVBAR */}
      <motion.header className="fixed top-0 w-full z-50 bg-white border-b border-gray-100 shadow-sm">
        <nav className="container mx-auto px-6">
          <div className="flex justify-between items-center py-3">
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              <div
                ...
                onMouseLeave={() => setPropertyOpen(false)}
              >
                <button className="flex items-center gap-1 px-5 py-2 rounded-full font-bold">
                ...
                <AnimatePresence>
                  {propertyOpen && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      exit={{ opacity: 0, y: 10 }}
                      className="absolute mt-2 w-72 bg-white rounded-xl shadow-xl border"
                    >
                      {propertyItems.map((item) => (
                        <button
                          key={item.label}
                ...
                <AnimatePresence>
                  {membersOpen && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      exit={{ opacity: 0, y: 10 }}
                      className="absolute mt-2 w-56 bg-white rounded-xl shadow-xl border"
                    >
                      <button
              ...
              {/* Auth */}
              {user ? (
                <button onClick={handleLogout} className="px-5 py-2 bg-gray-100 rounded-full">
                  <LogOut size={16} /> Logout
                </button>
              ) : (
                <button
